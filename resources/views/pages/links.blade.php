...
<div class="container position-relative">
    ...
    <div class="d-flex justify-content-between py-4">
        ...
        <div class="d-flex">
            <button data-bs-toggle="modal" class="btn btn-primary text-white"
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center align-middle">
                            ...
                            @else
                            <button type="submit" class="btn linkQRCode" style="
                                                font-size: 13px;
                                                background: #ebedef;
                                                padding: 1px 6px;
                                                font-weight: 500;
                        ...
                        <td class="align-middle d-flex justify-content-end">
                            <button class="btn link-control" data-bs-toggle="modal"
